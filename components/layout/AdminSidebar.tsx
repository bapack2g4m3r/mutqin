...
const navItems = [
  ...
  {
    id: 'nav-admin-setoran', href: '/admin/setoran', label: 'Riwayat Harian', section: 'Menu',
    icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>,
  },
  {
    id: 'nav-admin-laporan', href: '/admin/laporan', label: 'Rekapitulasi', section: 'Menu',
  ...
  {
    id: 'nav-admin-backup', href: '/admin/backup', label: 'Backup & Restore', section: 'Pengaturan',
